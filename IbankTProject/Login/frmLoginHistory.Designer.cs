namespace IBTpresentationLayer
{
    partial class frmLoginHistory
    {
        ...
        private void InitializeComponent()
        {
            ...
            cbFilter.Items.AddRange(new object[] { "None", "User ID", "Person ID", "Login Date/Time", "Full Name", "Country", "Gender" });
            ...
            dgvLoigns.Location = new Point(3, 84);
            ...
            dgvLoigns.Size = new Size(940, 614);
            dgvLoigns.TabIndex = 12;
            ...
            Name = "frmLoginHistory";
            Text = "frmLoginHistory";
            Load += frmLoginHistory_Load;
